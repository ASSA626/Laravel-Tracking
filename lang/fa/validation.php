...
return [
    ...
    'attributes'           => [
        ...
        'eitaa'                    => 'ایتا',
        'Services'                 => 'خدمات',
        'big_project'              => 'پروژه های بزرگ',
        'web_project'              => 'پروژه های تحت وب',
        'app_project'              => 'پروژه تحت اپ',
        'apartment'                => 'ساختمان',
        'complex'                  => 'مجتمع',
        'lastname'                 => 'نام خانوادگی',
        'citizens_problem'         => 'مشکل فرد',
        'family_number'            => 'تعداد اعضای خانواده',
        'job'                      => 'شغل',
        'desc'                     => 'واحد',
        'type_places'              => 'ساختمان/مجتمع',
        'apr_manage'               => 'مدیر ساختمان',
        'persons_number'           => 'تعداد افراد',
        'musk'                     => 'نام مسجد',
        'station'                  => 'نام پایگاه بسیج',
        'time_start'               => 'تاریخ شروع',
        'time_end'                 => 'تاریخ پایان',
        'valency'                  => 'ظرفیت',
        'valency_dregs'            => 'ظرفیت باقی مانده',
        'origin'                   => 'مکان شروع (مبدا)',
        'banner'                   => 'پوستر (تصویر اردو یا ...)',
        'hour_start'               => 'ساعت شروع',
        'hour_end'                 => 'ساعت پایان',
        'date_start'               => 'تاریخ شروع',
        'date_end'                 => 'تاریخ پایان',
        'pose'                     => 'تصویر تراکنش',
        'pose_image'               => 'تصویر تراکنش',
        'caption'                  => 'توضیحات',
        'code'                     => 'کد تایید',
        'father_name'              => 'نام پدر',
        'time_value'               => 'میزان کارکرد',
        'project'                  => 'پروژه',
        'value'                    => 'مقدار',
        'of_time'                  => 'از تاریخ',
        'to_time'                  => 'تا تاریخ',
        ...
        'transporter'             => 'وسیله حمل و نقل',
        'zip'                     => 'کدپستی',
        'personally_number'       => 'شماره پرسنلی',
        'bimeh_number'            => 'شماره بیمه',
        'mobile_friend'           => 'شماره یکی از نزدیکان',
        'home_phone'              => 'شماره تلفن منزل',
        'company_name'            => 'شرکت'
    ],
];
